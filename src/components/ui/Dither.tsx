...
class RetroEffectImpl extends Effect {
  // @ts-ignore – uniforms is inherited but we reuse the reference directly
...
const RetroEffect = forwardRef<RetroEffectImpl, RetroEffectProps>(({ colorNum, pixelSize }, ref) => {
  // @ts-ignore – wrapEffect ref typing is loose
